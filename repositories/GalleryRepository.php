...
class GalleryRepository {
    ...
    public function getPage(array $options = [])
    {
        ...
        if (!array_key_exists('joinPhotoCount', $options)) $options['joinPhotoCount'] = true;
        if (!array_key_exists('order', $options)) $options['order'] = 'desc';
        if (!array_key_exists('orderBy', $options)) $options['orderBy'] = 'created_at';
        if (!array_key_exists('page', $options)) $options['page'] = 1;
        if (!array_key_exists('pageSize', $options)) $options['pageSize'] = 10;
